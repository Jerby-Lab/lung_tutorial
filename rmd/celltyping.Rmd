---
title: "Single Cell RNA-seq Cell Typing Tutorial (Adapted and Expanded from Seurat)"
...
```{r var_features, fig.height=4, fig.width=9}
...
```{r tsne_plot, fig.height=4, fig.width=5}
...
```{r umapplot, fig.height=3, fig.width=8}
# note that you can set `label = TRUE` or use the LabelClusters function to help label individual clusters
colors <- readRDS("../data/colorBlind.rds")
a = DimPlot(scRNA_so, 
            pt.size = 0.1,
